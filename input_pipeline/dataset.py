...
class RealPairDataset(LidarBase):
    ...
    def get_pair(self, idx):
        ...
        flow, mask_valid_in_2, org_flow = self.get_pixel_match(mask2, source, target, corres, (h1, w1))
        # flow, mask_valid_in_2 = self.get_pixel_match_old(mask2, source, target)
    ...
    def get_pixel_match(self, mask2, source, target, corres, shape1):
        ...
        # mask_corres = np.where(corres == -1)
        # proj_x1[mask_corres] = 0
        # proj_y1[mask_corres] = 0
        # depth1[mask_corres] = 9999999
