...
from utils.data_conversion import LidarDataConverter, perform_kdtree, convert_to_world_frame, get_pixel_match
...
class DatasetCreator:
    def __init__(self, config):
        ...
        self.generate_ground_truth = self.config["generate_ground_truth"]
        ...
        self.lidar_data_converter = LidarDataConverter(
            ...
            save_dir=config["data_dir"], generate_gt=self.generate_ground_truth)
    ...
    def generate_pairs(self):
        ...
        for i, pose in enumerate(poses):
            try:
                ...
                # index = np.where((distances > mean_distance*0.5) & (distances <= mean_distance*0.75))
                for ix in index[0]:
                    try:
                        ...
                        flow = get_pixel_match(source_path, target_path)
